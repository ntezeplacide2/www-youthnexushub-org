          ...
          <div className="mb-8">
            ...
            <div className="text-center">
              ...
              <p className="text-xl text-foreground leading-relaxed max-w-3xl mx-auto">
                We're always looking to collaborate with purpose-driven people and organizations. Whether you're planning a campaign, co-hosting an event, or exploring sponsorship opportunities, we'd love to hear from you and explore how we can work together.
              </p>
            </div>
          </div>
